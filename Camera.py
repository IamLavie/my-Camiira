...
# try:
#     cluster = MongoClient("mongodb+srv://jhemercris_colas:Smartbro10@mycluster.itjla.mongodb.net/?retryWrites=true&w=majority")from gettext import find
from tkinter import *
import tkinter as tk
from tkinter import filedialog
from tkinter.filedialog import askopenfile
...
fs = gridfs.GridFS(db)
file = "C:/Users/Client/OneDrive/Documents/Python projects/New folder/Capture/1.png"
...
class Camiira:  
    ...
    # cap = cv2.VideoCapture(0)
            ...
            while cap.isOpened():
                ...
                if len(indexes) > 0:
                    ...
                    for id, box in centroid_dict.items():
                        ...
                        # post = {"_id": 0, "name": "Violators", "score": 0}
                        # collection_name.insert_one({post})
                        ...
                        #cv2.putText(frame,"FPS:"+str(np.round(fps,2)),(0,25),cv2.FONT_HERSHEY_COMPLEX,0.5,lable_color,1)
                        # ss_btn = Image.open('assets/placeholder/menu.png')
                        # photo = ImageTk.PhotoImage(ss_btn)
                        # ss_label= Label(frame, image=photo, bg="#B0AEAE")
                        # ss_label.image = photo
                        # ss_label.place(x=10, y=10) 
                        # screenss = Button(ss_label,text="Start Screen Capture", font=('yu gothic ui', 12, 'bold'), width=25, bd=0, bg='#0b2b25', fg='white', cursor='hand2', activebackground='#0b2b25', command=ss)
                        # screenss.place(x=8, y=5) 
        ...
        cam_btn = Image.open('assets/placeholder/menu.png')
        photo = ImageTk.PhotoImage(cam_btn)
        cam_label= Label(self.cammish, image=photo, bg="#B0AEAE")
        cam_label.image = photo
        cam_label.place(x=500, y=300) 
        self.cam = Button(cam_label, text='Connect to Camera', font=('yu gothic ui', 12, 'bold'), width=25, bd=0, bg='#0b2b25', fg='white', cursor='hand2', activebackground='#0b2b25')
        self.cam['command'] = v
